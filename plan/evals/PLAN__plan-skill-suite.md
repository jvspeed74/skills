...
| INV-06 | [V] The template is at `~/.claude/templates/PLANNING.TEMPLATE.md` at version 1.4.0, and defines the provenance marker set, the ID series, and the twelve-check pre-execute check | That file's frontmatter and header block |
...
|---|---|---|---|
| `~/.claude/skills/plan/SKILL.md` | Create | [D::DD-01] The hub: trigger gate, document instantiation, intent routing, phase sequence, all gates, investigation record, Revision Log, delivery | DD-01, DD-04, DD-15, DD-18 |
